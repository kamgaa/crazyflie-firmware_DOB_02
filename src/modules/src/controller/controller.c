...
#include "controller_mellinger_DOB.h" //ADDED
...
static ControllerFcns controllerFunctions[] = {
  ...
  {.init = controllerMellingerFirmwareInit_DOB, .test = controllerMellingerFirmwareTest_DOB, .update = controllerMellingerFirmware_DOB, .name = "MellingersDOB"}, //ADDED
...
void controllerInit(ControllerType controller) {
  ...
  #elif defined(CONFIG_CONTROLLER_MELLINGER_DOB)
    #define CONTROLLER ControllerTypeMellingerDOB
